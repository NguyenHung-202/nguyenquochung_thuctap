...
![Xác nhận đăng ký email SNS](/9.jpeg)
...
![Giao diện đăng nhập website](/10.png)
...
![Màn hình giao diện Dashboard quản lý](/11.png)
...
![Giao diện báo cáo kết quả chi tiết](/12.png)
...
![Thư báo điểm tự động từ SNS](/13.png)